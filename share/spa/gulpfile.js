...
var requireJsRuntimeConfig = vm.runInNewContext(fs.readFileSync('src/app/require.config.js') + '; require;'),
    requireJsOptimizerConfig = merge(requireJsRuntimeConfig, {
        ...
        include: [
            ...
            'components/nav-content/nav-content',
            'components/journal/journal',
            'components/journal/student',
            'components/journal/student-file',
            'components/journal/example',
            'components/journal/school',
            'components/home-page/home',
            'components/home-page/start',
...
gulp.task('css', function () {
    var bowerCss = gulp.src('src/bower_modules/components-bootstrap/css/bootstrap.css')
        ...
        bootstrapTheme = gulp.src('src/bower_modules/components-bootstrap/css/bootstrap-theme.css')
        appCss = gulp.src('src/css/*.css'),
        combinedCss = es.concat(bowerCss, bootstrapTheme, appCss).pipe(concat('proto-css.css')),
