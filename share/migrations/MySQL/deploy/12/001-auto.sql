...
-- Created on Mon Oct  3 03:43:34 2016
-- 
;
...
CREATE TABLE `note` (
  ...
  PRIMARY KEY (`note_id`),
  CONSTRAINT `note_fk_student_id` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `note_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
--
-- Table: `user_student`
--
